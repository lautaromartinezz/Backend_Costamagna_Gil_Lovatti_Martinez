...
function sanitizeUsuarioInput(req: Request, res: Response, next: NextFunction) {
    ...
    fechaNacimiento: req.body.fechaNacimiento !== undefined ? req.body.fechaNacimiento : null,
  }
...
async function findAll(req: Request, res: Response) {
    try{
      ...
      res.status(200).json({ message: 'Usuarios encontrados satisfactoriamente', data: usuarios })
    }catch (error: any) {
